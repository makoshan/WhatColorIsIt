...
public class View: ScreenSaverView {
	...
	public override func drawRect(rect: NSRect) {
        ...
        let string = "\(hourString):\(minuteString):\(secondString)" as NSString
	...
	private func updateFont() {
		font = fontWithSize(bounds.size.width / 10.0)
	}
	...
	private func fontWithSize(fontSize: CGFloat) -> NSFont {
		...
		if #available(OSX 10.11, *) {
            ...
            font = NSFont(name: "CenturyGothic-BoldItalic", size: fontSize)!
		} else {
